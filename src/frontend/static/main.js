...
var $author$project$Page$Home$deadEndsToString = function (deadEnds) {
	return A2(
		$elm$core$String$join,
		'\n',
				...
				_List_fromArray(
					[
						...
						var _v0 = A2(
							...
							A2(
								$elm$core$Result$mapError,
								$author$project$Page$Home$deadEndsToString,
								$dillonkearns$elm_markdown$Markdown$Parser$parse(post.text)));
						if (_v0.$ === 'Ok') {
							var rendered = _v0.a;
